...
export default function OperatorSessionDetails() {
  ...
  useEffect(() => {
    ...
    const useDummyData = () => {
      ...
      setSessionData({
        ...
        ended: sessionId === "c4b09654a413" || sessionId === "f89926cefc59" || sessionId === "8e17e075d8fa" ? "02/04/2025, 16:47:46" : "N/A",
        status: sessionId === "c4b09654a413" || sessionId === "f89926cefc59" || sessionId === "8e17e075d8fa" ? "Resolved" : "Active",
        priority: "High",
        assignedTo: "Unassigned",
        hasJoined: sessionId === "ebfa85eb1c97" || sessionId === "80b74a3e1f4b",
        resolvedBy: sessionId === "c4b09654a413" ? "Sarah Johnson" : sessionId === "f89926cefc59" ? "Michael Chen" : sessionId === "8e17e075d8fa" ? "Emily Rodriguez" : null,
        resolvedAt: sessionId === "c4b09654a413" || sessionId === "f89926cefc59" || sessionId === "8e17e075d8fa" ? "02/04/2025, 16:47:46" : null,
        conversation: [
          {
            id: "1",
            sender: "User",
  ...
  if (error || !sessionData) {
    return <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="text-red-500 text-xl">Error: {error || "Session not found"}</div>
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        <Card className="border-0 shadow-lg mb-6">
          <CardHeader className="bg-gradient-to-r from-indigo-700 to-indigo-900 text-white p-4 flex flex-row items-center justify-between">
            <div>
              <CardTitle className="text-xl font-bold">Session: {sessionId}</CardTitle>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gradient-to-b from-white to-slate-50 rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      <div className="bg-indigo-50 border-b border-indigo-100 px-4 py-3 flex items-center">
                        ...
                        <div>
                          <p className="text-sm font-medium text-slate-800">Interview Support Session</p>
                          <p className="text-xs text-slate-500">Started {sessionData.started}</p>
                        </div>
                      </div>

                      <div className="p-4 space-y-4 max-h-[500px] overflow-y-auto">
                        {sessionData.conversation.map((message: Message, index: number) => {
                          ...
                          return (
                            <div key={message.id} className={`${containerClasses} ${messageAlignment}`}>
                              ...
                              {index < sessionData.conversation.length - 1 && message.sender !== sessionData.conversation[index + 1].sender && (
                        ...
                        <div className="w-full p-4 bg-slate-50 border border-slate-200 rounded-lg">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-base font-semibold text-indigo-700">{sessionData.resolvedBy}</p>
                            </div>
                            <div>
                              <p className="text-sm font-medium text-slate-700">Resolved at</p>
                              <p className="text-sm text-slate-600">{sessionData.resolvedAt}</p>
                            </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="flex items-center">
                            <span className="bg-slate-200 rounded-md px-2 py-1 text-slate-400 text-xs font-mono">ID: {sessionId?.substring(0, 8)}</span>
